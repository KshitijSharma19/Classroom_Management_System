...
export default function Classes() {
  const classes = [
    { id: 'CS201', name: 'Data Structures', strength: 60, progress: 75, nextClass: 'Today, 10:00 AM' },
    { id: 'CS301', name: 'Web Development', strength: 45, progress: 60, nextClass: 'Today, 2:00 PM' },
    { id: 'CS401', name: 'Database Management', strength: 55, progress: 80, nextClass: 'Wednesday, 11:30 AM' },
  ];

  return (
    <div className="fade-in max-w-7xl mx-auto">
      <h2 className="text-2xl font-bold text-[#462F2D] dark:text-white mb-6">My Classes</h2>
      
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {classes.map(c => (
          <div key={c.id} className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-[#EBE0C8] dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow flex flex-col group">
            ...
            <h3 className="text-xl font-bold text-[#462F2D] dark:text-white mb-2">{c.name}</h3>
            <div className="flex items-center text-sm text-[#735A52] dark:text-gray-400 mb-6">
              <Users className="h-4 w-4 mr-2" />
              <span>{c.strength} Students Enrolled</span>
            </div>
            ...
            <div className="mt-auto">
              ...
              <div className="w-full bg-[#EBE0C8] dark:bg-gray-800 rounded-full h-2 mb-4">
                <div className="bg-[#935F53] dark:bg-indigo-500 h-2 rounded-full" style={{ width: `${c.progress}%` }}></div>
              </div>
              ...
              <div className="p-3 bg-[#FDF8F5] dark:bg-gray-800/50 border border-[#EBE0C8] dark:border-gray-700 rounded-xl text-sm font-medium flex justify-between items-center">
                ...
                <span className="text-[#935F53] dark:text-indigo-400 font-bold">{c.nextClass}</span>
              </div>
            </div>
          </div>
        ))}
